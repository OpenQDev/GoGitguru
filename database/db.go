...
func Prepare(ctx context.Context, db DBTX) (*Queries, error) {
	...
	if q.getGithubReposByBatchStmt, err = db.PrepareContext(ctx, getGithubReposByBatch); err != nil {
		return nil, fmt.Errorf("error preparing query GetGithubReposByBatch: %w", err)
	}
...
func (q *Queries) Close() error {
	...
	if q.getGithubReposByBatchStmt != nil {
		if cerr := q.getGithubReposByBatchStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing getGithubReposByBatchStmt: %w", cerr)
		}
	}
...
type Queries struct {
	...
	getGithubReposByBatchStmt                  *sql.Stmt
...
func (q *Queries) WithTx(tx *sql.Tx) *Queries {
	return &Queries{
		...
		getGithubReposByBatchStmt:                  q.getGithubReposByBatchStmt,
